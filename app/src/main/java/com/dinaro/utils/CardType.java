...
public enum CardType {
    ...
    public static int getDrawable(String cardType) {
        ...
        switch (cardType) {
            case "MPESA":
                return R.drawable.ic_half_mpesa;
            case "VISA":
                return R.drawable.visa_65_x_41;
            case "PAYPAL":
                return R.drawable.iv_paypal_half;

            case "MASTERCARD":
                return R.drawable.ic_half_mastercard;
            ...
            case "HIPER":
                return R.drawable.bt_ic_hiper;

            case "HIPERCARD":
                return R.drawable.bt_ic_hipercard;
