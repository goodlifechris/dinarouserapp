...
public class RobotoCalenderView extends LinearLayout
{
    ...
    private final View.OnClickListener onDayOfMonthClickListener = new View.OnClickListener() {
        @Override
    ...
    private final View.OnLongClickListener onDayOfMonthLongClickListener = new View.OnLongClickListener() {
        @Override
    ...
    public RobotoCalenderView(Context context) {
        super(context);
        init(null);
    }

    public RobotoCalenderView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public RobotoCalenderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public RobotoCalenderView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(@Nullable AttributeSet set) {
        ...
        rootView = inflate.inflate(com.marcohc.robotocalendar.R.layout.roboto_calendar_view_layout, this, true);
        ...
        ViewPump.init(ViewPump.builder()
                .addInterceptor(new CalligraphyInterceptor(
                        new CalligraphyConfig.Builder()
                                .setFontAttrId(com.marcohc.robotocalendar.R.attr.fontPath)
                                .build()))
                .build());
    }
    ...
    public void markDayAsSelectedDay(@NonNull Date date) {
        ...
        dayOfTheMonthBackground.setBackgroundResource(com.marcohc.robotocalendar.R.drawable.circle);

        TextView dayOfTheMonth = getDayOfMonthText(calendar);
        dayOfTheMonth.setTextColor(ContextCompat.getColor(getContext(), com.marcohc.robotocalendar.R.color.roboto_calendar_selected_day_font));
        ...
        if (circleImage1.getVisibility() == VISIBLE) {
            DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(getContext(), com.marcohc.robotocalendar.R.color.roboto_calendar_selected_day_font));
        }

        if (circleImage2.getVisibility() == VISIBLE) {
            DrawableCompat.setTint(circleImage2.getDrawable(), ContextCompat.getColor(getContext(), com.marcohc.robotocalendar.R.color.roboto_calendar_selected_day_font));
        }
    }
    ...
    public void clearSelectedDay() {
        if (lastSelectedDayCalendar != null) {
            ...
            if (nowCalendar.get(Calendar.YEAR) == lastSelectedDayCalendar.get(Calendar.YEAR) && nowCalendar.get(Calendar.DAY_OF_YEAR) == lastSelectedDayCalendar.get(Calendar.DAY_OF_YEAR)) {
                dayOfTheMonthBackground.setBackgroundResource(com.marcohc.robotocalendar.R.drawable.ring);
            } else {
            ...
            dayOfTheMonth.setTextColor(ContextCompat.getColor(getContext(), com.marcohc.robotocalendar.R.color.roboto_calendar_day_of_the_month_font));
            ...
            if (circleImage1.getVisibility() == VISIBLE) {
                DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(getContext(), com.marcohc.robotocalendar.R.color.roboto_calendar_circle_1));
            }

            if (circleImage2.getVisibility() == VISIBLE) {
                DrawableCompat.setTint(circleImage2.getDrawable(), ContextCompat.getColor(getContext(), com.marcohc.robotocalendar.R.color.roboto_calendar_circle_2));
            }
        }
    }
    ...
    private void findViewsById(View view) {
        ...
        robotoCalendarMonthLayout = view.findViewById(com.marcohc.robotocalendar.R.id.robotoCalendarDateTitleContainer);
        leftButton = view.findViewById(com.marcohc.robotocalendar.R.id.leftButton);
        rightButton = view.findViewById(com.marcohc.robotocalendar.R.id.rightButton);
        dateTitle = view.findViewById(com.marcohc.robotocalendar.R.id.monthText);
        ...
        for (int i = 0; i < 42; i++) {
            ...
            View dayOfTheMonthLayout = inflate.inflate(com.marcohc.robotocalendar.R.layout.roboto_calendar_day_of_the_month_layout, null);
    ...
    private void setUpEventListeners() {
        ...
        leftButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RobotoCalenderView.this.updateView();
...
//         System.out.println("fffffff"+dateText);
//        } else {
            dateTitle.setText(String.format("%s %s", dateText, currentCalendar.get(Calendar.YEAR)));
        AppConstant.CURRENTMONTH= String.format("%s %s", dateText, currentCalendar.get(Calendar.YEAR));
       // Toast.makeText(getContext(),""+String.format("%s %s", dateText, currentCalendar.get(Calendar.YEAR)),Toast.LENGTH_SHORT).show();
        //}
    }
    ...
    private void setUpWeekDaysLayout() {
        ...
        for (int i = 1; i < length; i++) {
           ...
           // Toast.makeText(getContext(),""+dayOfTheWeekString,Toast.LENGTH_SHORT).show();
        }
    ...
    private void setUpDaysOfMonthLayout() {
        ...
        for (int i = 1; i < 43; i++) {
            ...
            dayOfTheMonthText.setTextColor(ContextCompat.getColor(getContext(), com.marcohc.robotocalendar.R.color.roboto_calendar_day_of_the_month_font));
